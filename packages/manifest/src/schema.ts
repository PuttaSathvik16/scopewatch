 ...
 */
export function parseManifest(input: unknown): ValidationResult<ServerManifest> {
 ...
 */
export function validateManifest(manifest: unknown): ValidationResult<ServerManifest> {
 ...
 */
export function isServerManifest(value: unknown): value is ServerManifest {
