...
| **26** (Current) | Verified - CI passes on Linux, macOS, and Windows |

CI (`.github/workflows/ci.yml`) runs the full suite across 22.x, 24.x, and
26.x on all three platforms on every push, specifically to catch the class
